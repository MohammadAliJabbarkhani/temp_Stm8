 ...
 832  0092 81            	ret
 900                     ; 207 BitStatus GPIO_ReadInputPin(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
 900                     ; 208 {
 901                     	switch	.text
 902  0093               _GPIO_ReadInputPin:
 904  0093 89            	pushw	x
 905       00000000      OFST:	set	0
 908                     ; 209     return ((BitStatus)(GPIOx->IDR & (uint8_t)GPIO_Pin));
 910  0094 e601          	ld	a,(1,x)
 911  0096 1405          	and	a,(OFST+5,sp)
 914  0098 85            	popw	x
 915  0099 81            	ret
 993                     ; 219 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, FunctionalState NewState)
 993                     ; 220 {
 994                     	switch	.text
 995  009a               _GPIO_ExternalPullUpConfig:
 997  009a 89            	pushw	x
 998       00000000      OFST:	set	0
1001                     ; 222     assert_param(IS_GPIO_PIN_OK(GPIO_Pin));
1003                     ; 223     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1005                     ; 225     if (NewState != DISABLE) /* External Pull-Up Set*/
1007  009b 0d06          	tnz	(OFST+6,sp)
1008  009d 2708          	jreq	L374
1009                     ; 227         GPIOx->CR1 |= (uint8_t)GPIO_Pin;
1011  009f e603          	ld	a,(3,x)
1012  00a1 1a05          	or	a,(OFST+5,sp)
1013  00a3 e703          	ld	(3,x),a
1015  00a5 2009          	jra	L574
1016  00a7               L374:
1017                     ; 230         GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
